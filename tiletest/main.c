...
const u32 test[99] =
{
  0x00,0x00,0x00,0x00,0x11244211,0x00,0x00,0x00,0x00,
  0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
  0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
  0x00,0x00,0x00,0x00,0x00,0x00,0x11244211,0x00,0x00,
  0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
  0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
  0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
  0x00,0x00,0x00,0x00,0x11244211,0x00,0x00,0x00,0x00,
  0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
  0x00,0x00131200,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
  0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00111100
};
...
const u32 TileLabel[16] =
{
  0x00,0x00,0x60,0x00,0x18,0x60,0x40,0x48,
...
int main( )
{
	...
	VDP_loadTileData( (const u32 *)Robot, 0, 1, 0);

	//load the tile in VRAM (check it using GensKMod CPU>Debug>Genesis>VDP)
	//VDP_loadTileData( (const u32 *)Robot, TILE1, 1, 0);

	//draw this tile at (5,5) using PAL0
	//VDP_setTileMapXY(PLAN_A, TILE1, 5, 5);
...
/*
	...
	VDP_setTileMapXY(PLAN_B, TILE_ATTR_FULL(PAL2, 1, 0, 0, TILE1), 9, 7);
	VDP_setTileMapXY(PLAN_A, TILE_ATTR_FULL(PAL1, 1, 0, 0, TILE1), 9, 7);
	VDP_setTileMapXY(PLAN_B, TILE_ATTR_FULL(PAL2, 1, 0, 0, TILE1), 9, 7);
