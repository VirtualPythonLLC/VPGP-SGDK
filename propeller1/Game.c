...
void OpenInGameMenu()
{
    ...
    VDP_setVerticalScroll(VDP_PLAN_A, 0);
    VDP_setVerticalScroll(VDP_PLAN_B, 0);
    VDP_setHorizontalScroll(VDP_PLAN_A, 0);
    VDP_setHorizontalScroll(VDP_PLAN_B, 0);

    VDP_updateSprites();

    VDP_fillTileMapRect(VDP_PLAN_A, 0, 0, 0, 64, 64);
    VDP_fillTileMapRect(VDP_PLAN_B, 0, 0, 0, 64, 64);
